...
export class SelectAddressesComponent {
    ...
    private getUserLocation(): void {
        ...
        const geoSuccess = (position: GeolocationPosition) => {
            ...
            console.log("userLocation show",  this.selectAddressService.showUserLocation)
            console.log("real__userLocation====>", this.userLocation)
        ...
        navigator.permissions.query({name:'geolocation'}).then(function(result) {
            if (result.state == 'granted') {
             console.log("grantedgrantedgrantedgrantedgrantedgrantedgrantedgrantedgranted")
            } else if (result.state == 'prompt') {
             console.log("promptpromptpromptpromptprompt")
            }
    ...
    public setAddress(address: AddressDisplay): void {
        console.log("setAddress====> but showUserLocation ", this.selectAddressService.showUserLocation)
        
            console.log('calling setAddress');
            console.log(address);
            if (this.currentField === 'pickup' && !this.selectAddressService.showUserLocation) {
                console.log('calling selectPickupAddress');
    ...
    private resetAddresses(): void {
        console.log("resetAddress in select-addresses-component.ts")
