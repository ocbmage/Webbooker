...
export class APIService {
  ...
  async InsertTrip(
    ...
    if(ClientInfo2) {
      gqlAPIServiceArguments.ClientInfo1 = ClientInfo2;
    }

    if(ClientInfo3) {
      gqlAPIServiceArguments.ClientInfo1 = ClientInfo3;
    }

    if(ClientInfo4) {
      gqlAPIServiceArguments.ClientInfo1 = ClientInfo4;
    }

    if(ClientInfo5) {
      gqlAPIServiceArguments.ClientInfo1 = ClientInfo5;
    }

    if(ClientInfo6) {
      gqlAPIServiceArguments.ClientInfo1 = ClientInfo6;
    }

    if(ApiStage) gqlAPIServiceArguments.ApiStage = ApiStage;

    if(strAccountNbr) gqlAPIServiceArguments.strAccountNbr = strAccountNbr;

    console.log("gqlQuery:~~~~~~~~~~~~~~~", gqlAPIServiceArguments);
